...
MODIFY COLUMN id_utilisateur INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE Pôles
MODIFY COLUMN id_pôle INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE Salles
MODIFY COLUMN id_salle INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE Départements
MODIFY COLUMN id_département INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE Cycles
MODIFY COLUMN id_cycle INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE Matières
MODIFY COLUMN id_matière INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE Instruments
MODIFY COLUMN id_instrument INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE Cours
MODIFY COLUMN id_cours INT AUTO_INCREMENT PRIMARY KEY;